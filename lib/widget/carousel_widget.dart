              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Expanded(child: Text(article.title, style: titleArticleHeadline.copyWith(fontSize: 12))),
                      const SizedBox(height: 10),
                      Expanded(child: Text(article.author, style: authorDateArticleHeadline.copyWith(fontSize: 10),))
